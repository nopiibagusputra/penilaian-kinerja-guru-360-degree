                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('penilaian', $data->data_responden) }}" class="ladda-button mb-2 mr-2 btn btn-primary" data-style="expand-left">
