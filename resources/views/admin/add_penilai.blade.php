    ...
    <div class="col-lg-12">
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <form action="{{ route('store_penilai') }}" method="POST">
                    @csrf
                    <div class="position-relative row form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="nama_penilai" id="nama_penilai" class="multiselect-dropdown form-control">
                                @foreach($guru as $penilai)
                                    <option value="{{ $penilai->id_guru }}">{{ $penilai->nama." | ".$penilai->nama_mapel }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="position-relative row form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="nomor_sk_penugasan" id="nomor_sk_penugasan" placeholder="Masukkan nomor SK Penugasan"
                    ...
                    <div class="position-relative row form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="tanggal_sk_penugasan" id="tanggal_sk_penugasan" data-toggle="datepicker" class="form-control">
                        </div>
                    </div>
                    <div class="position-relative row form-group">
                        <label for="tanggal_berlaku_sk_penugasan" class="col-sm-2 col-form-label">Tanggal Berlaku SK</label>
                        <div class="col-sm-10">
                            <input name="tanggal_berlaku_sk_penugasan" id="tanggal_berlaku_sk_penugasan" data-toggle="datepicker" class="form-control">
                        </div>
                    </div>
                    <div class="position-relative row form-group">
                        <label for="tahun_penilaian" class="col-sm-2 col-form-label">Tahun Penilaian</label>
                        <div class="col-sm-10">
                            <input name="tahun_penilaian" id="tahun_penilaian" placeholder="Masukkan tahun penilaian"
                                type="text" class="form-control">
                        </div>
                    </div>
                    <hr>
                    <div class="position-relative row form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="tanggal_penilaian" id="tanggal_penilaian" data-toggle="datepicker" class="form-control">
                        </div>
                    </div>
                    <div class="position-relative row form-group">
                        <label for="periode_penilaian_awal" class="col-sm-2 col-form-label">Periode Penilaian Awal</label>
                        <div class="col-sm-10">
                            <input name="periode_penilaian_awal" id="periode_penilaian_awal" data-toggle="datepicker" class="form-control">
                        </div>
                    </div>
                    <div class="position-relative row form-group">
                        <label for="periode_penilaian_akhir" class="col-sm-2 col-form-label">Periode Penilaian Akhir</label>
                        <div class="col-sm-10">
                            <input name="periode_penilaian_akhir" id="periode_penilaian_akhir" data-toggle="datepicker" class="form-control">
                        </div>
                    </div>
