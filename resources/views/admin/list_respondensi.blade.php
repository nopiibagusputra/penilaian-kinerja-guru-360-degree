                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('edit_responden', $data->id_kode_respondensi) }}" class="pr-2">
                                    <span class="btn-icon-wrapper opacity-7">
                                        <i class="fa fa-user-plus fa-w-20"></i>
                                    </span>
                                    Edit
                                </a>
                                <a href="{{ route('hapus_responden', $data->id_kode_respondensi) }}" style="color: red">
                                    <span class="btn-icon-wrapper opacity-7">
