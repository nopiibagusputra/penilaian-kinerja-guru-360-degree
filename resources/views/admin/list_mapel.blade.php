    ...
    <div class="page-title-wrapper">
        ...
        <div class="page-title-actions">
            <div class="d-inline-block dropdown">
                <a class="btn-shadow btn btn-info" href="{{ route('add_mapel') }}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('edit_mapel', $data->id_mapel) }}" class="pr-2">
                                    <span class="btn-icon-wrapper opacity-7">
                                        <i class="fa fa-user-plus fa-w-20"></i>
                                    </span>
                                    Edit
                                </a>
                                <a href="{{ route('hapus_mapel', $data->id_mapel) }}" style="color: red">
                                    <span class="btn-icon-wrapper opacity-7">
