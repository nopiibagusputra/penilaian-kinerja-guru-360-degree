    ...
    <div class="page-title-wrapper">
        ...
        <div class="page-title-actions">
            {{-- <div class="d-inline-block dropdown">
                <a class="btn-shadow btn btn-info" href="{{ route('add_kelas_ajar') }}">
            ...
            <div class="card-body">
                ...
                <table class="mb-0 table table-hover" id="example">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center"><button class="btn-wide mb-2 mr-2 btn-pill btn btn-primary btn-sm">{{ $data->nama_kelas }}</button></td>
                            <td class="text-center">
                                <a href="{{ route('edit_kelas_ajar', $data->id_kelas) }}" class="pr-2">
