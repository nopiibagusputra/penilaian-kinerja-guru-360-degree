            ...
            <div class="card-body">
                ...
                <table class="mb-0 table table-hover" id="example">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th style="width: 70%" >Nama Kompetensi</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('edit_kompetensi', $data->id_kompetensi) }}" class="pr-2">
                                    <span class="btn-icon-wrapper opacity-7">
                                        <i class="fa fa-user-plus fa-w-20"></i>
                                    </span>
                                    Edit
                                </a>
                                <a href="{{ route('hapus_kompetensi', $data->id_kompetensi) }}" style="color: red">
                                    <span class="btn-icon-wrapper opacity-7">
