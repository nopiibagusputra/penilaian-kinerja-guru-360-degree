            ...
            <div class="card-body">
                ...
                <table class="mb-0 table table-hover" id="example">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$i++}}</td>
                            <td style="width: 400px">{{ $data->nama_pernyataan }}</td>
                            <td>{{ $data->nama_respondensi }}</td>
                            <td>{{ $data->nama_komponen }}</td>
                            <td class="text-center">
                                <a href="{{route('edit_pernyataan', $data->id_pernyataan)}}" class="pr-2">
                                    <span class="btn-icon-wrapper opacity-7">
                                        <i class="fa fa-user-plus fa-w-20"></i>
                                    </span>
                                    Edit
                                </a>
                                <a href="{{route('hapus_pernyataan', $data->id_pernyataan)}}" style="color: red">
                                    <span class="btn-icon-wrapper opacity-7">
