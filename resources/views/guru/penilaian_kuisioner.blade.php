...
@endif
@endforeach
<form action="{{ route('store_nilai_repondensi_guru') }}" id="form_kuis" method="POST">
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> {{ round($total_kinerja,2); }}</td>
                            </tr>
                            <tr>

                                <th>Sebutan<br>(0% < X = 25% = Kurang; 25% < X = 50% = Sedang; 50% < X = 75% = Cukup; 75% < X = 100% = Baik)</th>
                                <td> <span class="badge badge-success">{{ ($total_kinerja<=25)?'Kurang':(($total_kinerja<=50)?'Sedang':(($total_kinerja<=75)?'Cukup':'Baik')) }}</span></td>
                            </tr>
                        </tbody>
                    </table> --}}
