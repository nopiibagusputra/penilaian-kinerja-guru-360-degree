...
<body>
    <div>
        ...
        <h4>
            <center>REKAP HASIL PENILAIAN KINERJA GURU KELAS/MATA PELAJARAN</center>
        </h4>
        <table>
            <tbody>
                <tr>
            ...
            @foreach($data as $pk)
                <tr>
                    ...
                    <td style="text-align: center">
                        {{ ((isset($pk_info[$pk->id_kompetensi]))?$pk_info[$pk->id_kompetensi]:"-") }}
                    </td>
                </tr>
            @endforeach
            <tr>
                <td colspan="2">Jumlah (Hasil Penilaian Kinerja Guru)</td>
                <td style="text-align: center">{{ $total_kom }}</td>
            </tr>
            <tr>
                <td colspan="2">Konversi nilai PK Guru ke dalam skala 0 - 100</td>
                <td style="text-align: center">{{ round($total_kom/(count($data)*4)*100,2) }}</td>
            </tr>
        </tbody>
    </table>
    <p>*) Nilai Diisi Berdasarkan Laporan Dan Evaluasi PK Guru. Nilai Minimum Per Kompetensi = 1 Dan Nilai Maksimum = 4
    </p>
    <br>
    <br>
