...
class ManagementController extends Controller
{
    ...
    public function list_penilaian()
    {
        ...
        $ids_pernyataan = array_column($kuis_data->toArray(), 'id_pernyataan');
        $output = [];
        foreach ($data_kuis as $val) {
            $total = PenilaianRespondensi::where(['id_responden'=>$id_siswa,'id_guru'=>$val->id_guru])->whereIn('id_pernyataan', $ids_pernyataan)->get();
            $obj=new \stdClass;
        ...
        //dd($output);
        return view('siswa.daftar_penilaian', [
            'data' => $output
        ]);
    }
    ...
    public function penilaian($id)
    {
        ...
        //dd($kuisnya);
        return view('siswa.penilaian_kuisioner', [
    ...
    public function store_nilai_penilaian(Request $request)
    {
        ...
        return redirect('/siswa/penilaian/' . $request->id_kuis);
    }
